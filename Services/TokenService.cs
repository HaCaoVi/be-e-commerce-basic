...
namespace e_commerce_basic.Services
{
    public class TokenService : ITokenService
    {
        ...
        {
            _config = config;
            var signingKey = _config["JWT:SigningKey"] ?? throw new ApplicationException("JWT:SigningKey is missing");
        ...
        public string CreateAccessToken(NewTokenDto newTokenDto)
        {
            ...
            int accessTokenExpire = int.Parse(_config["JWT:AccessTokenExpire"] ?? throw new ApplicationException("JWT:AccessTokenExpire is missing"));
        ...
        public string CreateRefreshToken(NewTokenDto newTokenDto)
        {
            ...
            var roleName = newTokenDto.RoleName ?? throw new ApplicationException("Role name is missing");
            var username = newTokenDto.Username ?? throw new ApplicationException("Username is missing");
            int refreshTokenExpire = int.Parse(_config["JWT:RefreshTokenExpire"] ?? throw new ApplicationException("JWT:RefreshTokenExpire is missing"));
